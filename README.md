...
If you don't want to use vault, you need to set passwords using these environment variables: `HARBOR_PWD`, `GRAFANA_PWD INFLUXDB_PWD`, `KUBELOGIN_CLIENT_SECRET`, `GRAFANA_CLIENT_SECRET`, `CUSTOMER_PROMETHEUS_PWD`, `CUSTOMER_ALERTMANAGER_PWD`.
