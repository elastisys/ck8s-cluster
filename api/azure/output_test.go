...
func TestTerraformOutputBaseDomain(t *testing.T) {
	testCases := map[api.ClusterType]string{
		api.ServiceCluster:  "ck8stest.azure-domain.com",
		api.WorkloadCluster: "ck8stest.azure-domain.com",
	}
