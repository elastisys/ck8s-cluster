...
#retention variables
export AL_RETENTION_SIZE=${AL_RETENTION_SIZE:-100}
export AL_RETENTION_AGE=${AL_RETENTION_AGE:-30}
export APIL_RETENTION_SIZE=${APIL_RETENTION_SIZE:-10}
export APIL_RETENTION_AGE=${APIL_RETENTION_AGE:-10}
