...
export TF_VAR_ssh_pub_key_file_ss=${SSH_PATH}.pub
export TF_VAR_ssh_pub_key_file_c=${SSH_PATH}.pub
export TF_VAR_exoscale_api_key=$EXOSCALE_API_KEY
export TF_VAR_exoscale_secret_key=$EXOSCALE_SECRET_KEY
#export ECK_SS_DOMAIN=emil-ss.compliantkubernetes.com
#export ECK_C_DOMAIN=emil-c.compliantkubernetes.com
