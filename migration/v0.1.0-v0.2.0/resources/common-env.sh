...
# NOTE: This differs from the old common-env where the SLACK_API_URL had a
#       a default URL. This has been removed and forces you to explicitly add
#       it to the secrets.env instead.
# export SLACK_API_URL=${SLACK_API_URL:-[REDACTED]}
...
export PROMETHEUS_RETENTION_WC=${PROMETHEUS_RETENTION_WC:-3d}
export PROMETHEUS_STORAGE_SIZE_WC=${PROMETHEUS_STORAGE_SIZE_WC:-"5Gi"}
export PROMETHEUS_RETENTION_SIZE_WC=${PROMETHEUS_RETENTION_SIZE_WC:-"4GiB"}

export PROMETHEUS_RETENTION_SC=${PROMETHEUS_RETENTION_SC:-3d}
export PROMETHEUS_STORAGE_SIZE_SC=${PROMETHEUS_STORAGE_SIZE_SC:-"5Gi"}
export PROMETHEUS_RETENTION_SIZE_SC=${PROMETHEUS_RETENTION_SIZE_SC:-"4GiB"}

export ALERTMANAGER_RETENTION=${ALERTMANAGER_RETENTION:-72h}
